...
export const conversionCategories: ConversionCategory[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      { id: "epub-to-pdf",   label: "EPUB → PDF",       description: "E-book to PDF",                      icon: <BookOpen className="w-5 h-5" />,          accept: ".epub",       badge: "Soon" },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      { id: "crop-image",      label: "Crop Image",      description: "Crop to centre square",                icon: <Scissors className="w-5 h-5" />,    accept: ".jpg,.jpeg,.png,.webp",        badge: "Soon" },
    ],
  },
  // ─────────────────────────────────────────────────────────────────────────
  {
